...
[![better cutter minecraft datapack github issues](https://cdn.jsdelivr.net/gh/jodeks-datapacks/Assets@main/badges/GH_Issues.png)](https://github.com/jodeks-datapacks/better-cutter/issues)&nbsp;&nbsp;
...
### Copper
Copper block --> 4 Copper doors, 3 Lightning rods, 2 trapdoors, 24 Copper bars, 8 Copper chain

Remove wax from waxed copper items

Turn copper items one stage back (e.g. oxidized --> weathered)
...
Plank --> 4 buttons | 1 fence gate | 2 fence | 2 pressure plates | 1 sign | 2 slabs | 1 stairs | 1 trapdoor

Stripped Log --> 1 hanging sign | 2 doors | 4 planks | 1 shelf
